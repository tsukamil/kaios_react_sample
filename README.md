...
Simple example of a to-do list with improved scrolling. Orginal can be found on [KaiOS Developer Portal](https://developer.kaiostech.com/getting-started/build-your-first-app/sample-code#react)
